      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-3 h-16 items-center">
          ...
          <div className="col-span-1 flex items-center">
            <Link href="/" className="inline-flex items-center" aria-label="Ketspen home">
              <Image
          ...
          <ul className="hidden md:flex col-span-1 justify-center gap-10 text-md font-medium" role="list">
            <li>
            ...
            <li>
              <Link href="/company" className="text-gray-800 hover:text-gray-900">
                Company
              </Link>
            </li>
          </ul>
