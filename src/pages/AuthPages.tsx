...
const AuthFooter: React.FC = () => (
  <div className="text-center text-xs text-gray-500">
    ...
    <Link to="/privacy" className="underline hover:text-gray-700">Privacy Policy</Link>, and to
...
const OAuthButton: React.FC<{ icon?: React.ReactNode; label: string; onClick: () => void }> = ({ icon, label, onClick }) => (
  <button
    onClick={onClick}
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-center text-gray-600">
            Have an account?{' '}
            <Link to="/signin" className="text-black hover:underline font-medium">Sign In Now</Link>
          </p>
        </div>
...
export const ForgotPasswordPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full space-y-4 text-center">
          ...
          <Link to="/signin" className="inline-block mt-4 text-green-600 hover:underline font-medium">Back to Sign In</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        <AuthHeader title="Reset Your Password" description="Enter your email address and we'll send you a reset link" />
        ...
        <div className="text-center">
          <Link to="/signin" className="text-gray-600 hover:text-gray-800">Back to Sign In</Link>
        </div>
      </div>
    </div>
  );
