...
const BOX_SHADOW = "0 2px 8px rgba(0, 0, 0, 0.12), 0 1px 2px rgba(0, 0, 0, 0.08)";
...
export const Navbar = () => {
    ...
    return (
        <nav aria-label="Primary" className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-sm">
            <div className="mx-auto flex h-16 items-center px-8 max-w-7xl">
                <Link href="/" className="inline-flex items-center" aria-label="Sevenfold home">
                    <Image src="/branding/logo-long.svg" alt="Sevenfold logo" width={156} height={46} priority />
                </Link>
            ...
            <div
                id="mobile-nav"
                className={`md:hidden fixed inset-x-0 top-0 bg-background transition-transform duration-300 ${isOpen ? "translate-y-0" : "-translate-y-full"}`}
            >
