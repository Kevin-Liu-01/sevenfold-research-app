        ...
        <div ref={avatarRef} className="relative mt-6">
            ...
            >
                <img
                    ...
                    className="h-11 w-11 mx-auto rounded-full border-2 border-gray-400 cursor-pointer transition-all duration-200 hover:border-gray-500 hover:shadow-md"
            ...
            <div
                ...
                } ml-2 w-max bg-app-inner border-2 border-gray-500 rounded-xl shadow-xl overflow-hidden z-40`}
            >
