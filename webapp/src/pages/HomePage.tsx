...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-app-outer">
            {/* Header */}
            <header className="bg-app-inner shadow-sm border-b-2 border-gray-400">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="text-gray-700 hover:text-[var(--color-off-black)] border-2 border-gray-500 rounded-lg px-4 py-2 hover:bg-gray-100 transition-all duration-200 font-medium"
                            >
                                Sign Out
                            </button>
                            <button
                                onClick={() => navigate("/settings", { state: { from: "home" } })}
                                className="inline-flex items-center gap-2 px-4 py-2 text-gray-700 hover:text-[var(--color-off-black)] border-2 border-gray-500 rounded-lg hover:bg-gray-100 transition-all duration-200 font-medium"
                                title="User Settings"
                            >
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                    ...
                    {/* View Toggle */}
                    <div className="flex items-center bg-app-inner border-2 border-gray-500 rounded-lg p-1 shadow-sm">
                        <button
                ...
                {filteredProjects.length === 0 ? (
                    ...
                    <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredProjects.map((project) => (
                                    <div
                                        ...
                                        className="group bg-app-inner p-6 rounded-2xl border-2 border-gray-400 hover:border-viix-orange-400 hover:shadow-lg transition-all duration-200 cursor-pointer"
                                    >
                        ...
                        {/* Table View */}
                        {viewType === "table" && (
                            <div className="bg-app-inner rounded-2xl border-2 border-gray-400 overflow-hidden shadow-md">
